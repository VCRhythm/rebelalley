...
class PathsControllerTest < ActionController::TestCase
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post :create, path: { clip_id: @path.clip_id, next: @path.next, prev: @path.prev, video_id: @path.video_id, when: @path.when }
    end
  ...
  test "should update path" do
    put :update, id: @path, path: { clip_id: @path.clip_id, next: @path.next, prev: @path.prev, video_id: @path.video_id, when: @path.when }
    assert_redirected_to path_path(assigns(:path))
  end
